...
var t = {},
  ...
  ne = /-\w/g,
  T = te((e) => e.replace(ne, (e) => e.slice(1).toUpperCase())),
  re = /\B([A-Z])/g,
  E = te((e) => e.replace(re, `-$1`).toLowerCase()),
        ...
        : p(t)
          ...
          : _(t)
            ...
            : v(t) && !d(t) && !C(t)
              ? String(t)
              : t,
  Se = (e, t = ``) => (_(e) ? `Symbol(${e.description ?? t})` : e),
  j,
  Ce = class {
    constructor(e = !1) {
      ((this.detached = e),
        ...
        !e &&
          ...
          (j.active
            ? ((this.parent = j),
              (this.index = (j.scopes ||= []).push(this) - 1))
  ...
  Ee = class {
    constructor(e) {
      ((this.fn = e),
        ...
        j && (j.active ? j.effects.push(this) : (this.flags &= -2)));
    }
    pause() {
      this.flags |= 64;
    }
    resume() {
      this.flags & 64 &&
        ((this.flags &= -65),
        Te.has(this) && (Te.delete(this), this.trigger()));
    }
    notify() {
...
function Pe(e) {
  ...
  for (; r; ) {
    let e = r.prevDep;
    (r.version === -1 ? (r === n && (n = e), Le(r), Re(r)) : (t = r),
...
function Fe(e) {
  for (let t = e.deps; t; t = t.nextDep)
    if (
      ...
      (t.dep.computed && (Ie(t.dep.computed) || t.dep.version !== t.version))
    )
      return !0;
  return !!e._dirty;
}
function Ie(e) {
  if (
    ...
    ((e.globalVersion = Ue),
    !e.isSSR && e.flags & 128 && ((!e.deps && !e._dirty) || !Fe(e)))
  )
    return;
  e.flags |= 2;
  let t = e.dep,
...
var Ue = 0,
  ...
  Ge = class {
    ...
    track(e) {
      ...
      if (t === void 0 || t.sub !== M)
        ((t = this.activeLink = new We(M, this)),
          M.deps
...
function Ze(e, t, n, r, i, a) {
  ...
  if ((je(), t === `clear`)) o.forEach(s);
    ...
    if (i && n === `length`) {
      ...
      switch (
        ((n !== void 0 || o.has(void 0)) && s(o.get(n)), a && s(o.get(Xe)), t)
      ) {
        case `add`:
...
function Qe(e) {
  let t = L(e);
  return t === e ? t : (P(t, `iterate`, Xe), I(e) ? t : t.map(R));
}
function $e(e) {
  return (P((e = L(e)), `iterate`, Xe), e);
}
function F(e, t) {
  return Ft(e) ? Rt(Pt(e) ? R(t) : t) : R(t);
}
var et = {
  __proto__: null,
  [Symbol.iterator]() {
...
var st = e(`__proto__,__v_isRef,__isVue`),
  ct = new Set(
...
var ut = class {
    ...
    get(e, t, n) {
      ...
      if (t === `__v_raw`)
        return n === (r ? (i ? Ot : Dt) : i ? Et : Tt).get(e) ||
  ...
  dt = class extends ut {
    ...
    set(e, t, n, r) {
      ...
      if (!this._isShallow) {
        let e = Ft(i);
        if ((!I(n) && !Ft(n) && ((i = L(i)), (n = L(n))), !a && z(i) && !z(n)))
          return (e || (i.value = n), !0);
      }
      let o = a ? Number(t) < e.length : u(e, t),
        s = Reflect.set(e, t, n, z(e) ? e : r);
      return (
        e === L(r) &&
          (o ? D(n, i) && Ze(e, `set`, t, n, i) : Ze(e, `add`, t, n)),
        s
      );
    }
    deleteProperty(e, t) {
...
function bt(e, t) {
  let n = {
    ...
    get size() {
      let t = this.__v_raw;
      return (!e && P(L(t), `iterate`, Je), t.size);
    },
    has(t) {
      let n = this.__v_raw,
        r = L(n),
      ...
      e
        ...
        : {
            ...
            set(e, n) {
              ...
              return (
                r.set(e, n),
                o ? D(n, s) && Ze(r, `set`, e, n, s) : Ze(r, `add`, e, n),
                this
              );
            },
            delete(e) {
...
function Lt(e) {
  return (
    !u(e, `__v_skip`) && Object.isExtensible(e) && O(e, `__v_skip`, !0),
    e
  );
}
var R = (e) => (v(e) ? At(e) : e),
...
var Gt = class {
  ...
  notify() {
    if (((this.flags |= 16), !(this.flags & 8) && M !== this))
      return (Ae(this, !0), !0);
  }
  get value() {
...
function Zt(e, n, i = t) {
  let {
    ...
    p = (e) => (o ? e : I(e) || o === !1 || o === 0 ? Qt(e, 1) : Qt(e)),
    m,
    g,
    _,
    v,
  ...
  let C = b ? Array(e.length).fill(qt) : qt,
    w = (e) => {
      if (!(!(m.flags & 1) || (!m.dirty && !e)))
        if (n) {
          ...
          if (o || y || (b ? e.some((e, t) => D(e, C[t])) : D(e, C))) {
            ...
            Yt = m;
            try {
              let t = [e, C === qt ? void 0 : b && C[0] === qt ? [] : C, v];
              ((C = e), f ? f(n, 3, t) : n(...t));
            } finally {
              Yt = t;
            }
...
function Qt(e, t = 1 / 0, n) {
  if (
    ...
    return e;
  if ((n.set(e, t), t--, z(e))) Qt(e.value, t, n);
...
function un(e) {
  if (!(e.flags & 1)) {
    let t = hn(e),
      n = V[V.length - 1];
    (!n || (!(e.flags & 2) && t >= hn(n)) ? V.push(e) : V.splice(ln(t), 0, e),
      (e.flags |= 1),
      dn());
  }
}
...
var hn = (e) => (e.id == null ? (e.flags & 2 ? -1 : 1 / 0) : e.id);
function gn(e) {
  try {
...
function Dn(e, t, n) {
  let r = this.proxy,
    i = g(e) ? (e.includes(`.`) ? On(r, e) : () => r[e]) : e.bind(r, r),
    a;
...
function Un(e, t, n = $) {
  ...
  if ((Gn(t, r, n), n)) {
    let e = n.parent;
    for (; e && e.parent; )
      (Bn(e.parent.vnode) && Wn(r, t, n, e), (e = e.parent));
  }
}
function Wn(e, t, n, r) {
  let i = Gn(t, e, r, !0);
...
function ir(e, t, n, r) {
  ...
  if (o || g(e)) {
    let n = o && Pt(e),
      r = !1,
      s = !1;
    (n && ((r = !I(e)), (s = Ft(e)), (e = $e(e))), (i = Array(e.length)));
    for (let n = 0, o = e.length; n < o; n++)
      i[n] = t(r ? (s ? Rt(R(e[n])) : R(e[n])) : e[n], n, void 0, a && a[n]);
...
var ar = (e) => (e ? (Ki(e) ? na(e) : ar(e.parent)) : null),
  ...
  sr = (e, n) => e !== t && !e.__isScriptSetup && u(e, n),
  cr = {
    get({ _: e }, n) {
  ...
  return (
    s
      ...
      : !i.length && !n && !r
        ? (c = t)
        : ((c = {}),
          i.length && i.forEach((e) => gr(c, e, o, !0)),
          gr(c, t, o)),
    v(t) && a.set(t, c),
    c
  );
...
function Sr(e, t) {
  return e
    ? d(e) && d(t)
      ? [...new Set([...e, ...t])]
      : s(Object.create(null), lr(e), lr(t ?? {}))
    : t;
}
function Cr(e, t) {
  if (!e) return t;
...
function Nr(e) {
  ...
  if (y && g !== !1) {
    ...
    e.length &&
      t & 7 &&
      (a && e.some(o) && (y = Fr(y, a)), (b = Mi(b, y, !1, !0)));
  }
  return (
    n.dirs &&
      ((b = Mi(b, null, !1, !0)),
      (b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs)),
    n.transition && Mn(b, n.transition),
    (v = b),
    vn(_),
    v
  );
...
var Br = {},
  Vr = () => Object.create(Br),
  Hr = (e) => Object.getPrototypeOf(e) === Br;
function Ur(e, t, n, r = !1) {
  let i = {},
    a = Vr();
  ((e.propsDefaults = Object.create(null)), Gr(e, t, i, a));
  for (let t in e.propsOptions[0]) t in i || (i[t] = void 0);
  (n ? (e.props = r ? i : jt(i)) : e.type.props ? (e.props = i) : (e.props = a),
    (e.attrs = a));
}
function Wr(e, t, n, r) {
  let {
...
var Xr = (e) => e === `_` || e === `_ctx` || e === `$stable`,
  Zr = (e) => (d(e) ? e.map(Z) : [Z(e)]),
  Qr = (e, t, n) => {
    if (t._n) return t;
    let r = yn((...e) => Zr(t(...e)), n);
    return ((r._c = !1), r);
...
function ai(e, i) {
  ...
  let {
    ...
    v = (
      ...
      if (e === t) return;
      (e && !Ei(e, t) && ((r = ye(e)), k(e, i, a, !0), (e = null)),
      ...
      u != null && i
        ? Ln(u, e && e.ref, a, t || e, !t)
        : u == null && e && e.ref != null && Ln(e.ref, null, a, e, !0);
    },
    y = (e, t, n, r) => {
    ...
    te = (e, t, n, r, i, a, s, u) => {
      ...
      if (
        ...
        h & 8
          ? p(d, e.children)
          : h & 16 && T(e.children, d, null, r, i, oi(e, a), s, u),
        _ && bn(e, null, r, `created`),
    ...
    ne = (e, t, n, r, i) => {
      ...
      if (i) {
        ...
        if (
          t === n ||
          (mi(n.type) && (n.ssContent === t || n.ssFallback === t))
        ) {
          let t = i.vnode;
    ...
    T = (e, t, n, r, i, a, o, s, c = 0) => {
      for (let l = c; l < e.length; l++)
        v(null, (e[l] = s ? Fi(e[l]) : Z(e[l])), t, n, r, i, a, o, s);
    },
    re = (e, n, r, i, a, o, s) => {
      let l = (n.el = e.el),
      ...
      if (
        ...
        f && bn(n, e, r, `beforeUpdate`),
        r && si(r, !0),
        ((m.innerHTML && h.innerHTML == null) ||
          (m.textContent && h.textContent == null)) &&
          p(l, ``),
        d
          ? E(e.dynamicChildren, d, l, r, i, oi(n, a), o)
          : s || de(e, n, l, null, r, i, oi(n, a), o, !1),
        u > 0)
      ) {
    ...
    E = (e, t, n, r, i, a, o) => {
      for (let s = 0; s < t.length; s++) {
        ...
        v(
          c,
          l,
          c.el && (c.type === K || !Ei(c, l) || c.shapeFlag & 198)
            ? m(c.el)
            : n,
          null,
          r,
    ...
    ie = (e, n, r, i, a) => {
      if (n !== r) {
        if (n !== t)
          for (let t in n) !ee(t) && !(t in r) && c(e, t, n[t], null, a, i);
        for (let t in r) {
          if (ee(t)) continue;
          let o = r[t],
            s = n[t];
    ...
    ae = (e, t, n, r, i, a, s, c, l) => {
      ...
      (h && (c = c ? c.concat(h) : h),
        e == null
          ? (o(d, n, r), o(f, n, r), T(t.children || [], n, f, i, a, s, c, l))
          : p > 0 &&
              p & 64 &&
              m &&
              e.dynamicChildren &&
              e.dynamicChildren.length === m.length
            ? (E(e.dynamicChildren, m, n, i, a, s, c),
              (t.key != null || (i && t === i.subTree)) && li(e, t, !0))
            : de(e, t, n, f, i, a, s, c, l));
    },
    D = (e, t, n, r, i, a, o, s, c) => {
      ((t.slotScopeIds = s),
        e == null
    ...
    O = (e, t, n, r, i, a, o) => {
      ...
      if ((Bn(e) && (s.ctx.renderer = xe), Ji(s, !1, o), s.asyncDep)) {
    ...
    ce = (e, t, n, r, i, a, o) => {
      let s = () => {
        if (e.isMounted) {
          ...
          if (
            ...
            let t = () => {
              ((e.subTree = Nr(e)), j(s, e.subTree, e, i, null));
            };
          ...
          ((t.shapeFlag & 256 ||
            (d && zn(d.vnode) && d.vnode.shapeFlag & 256)) &&
            e.a &&
            G(e.a, i),
            (e.isMounted = !0),
            (t = n = r = null));
      ...
      ((u.i = e), (u.id = e.uid), (c.scheduler = () => un(u)), si(e, !0), l());
    },
    ue = (e, t, n) => {
      t.component = e;
      let r = e.vnode.props;
      ...
      m & 8
        ...
        : u & 16
          ? m & 16
            ? pe(l, d, n, r, i, a, o, s, c)
            : ve(l, i, a, !0)
          : (u & 8 && p(n, ``), m & 16 && T(d, n, r, i, a, o, s, c));
    },
      ...
      if (u > f) {
        if (u <= p) {
          let e = p + 1,
            n = e < d ? t[e].el : i;
          for (; u <= p; )
            (v(null, (t[u] = l ? Fi(t[u]) : Z(t[u])), r, n, a, o, s, c, l),
              u++);
        }
    ...
    me = (e, t, n, r, i = null) => {
      ...
      if (r !== 2 && d & 1 && l)
        if (r === 0)
          l.persisted && !a[jn]
            ? o(a, t, n)
            : (l.beforeEnter(a), o(a, t, n), G(() => l.enter(a), i));
        else {
    ...
    k = (e, t, n, r = !1, i = !1) => {
      ...
      let h = u & 1 && f,
        g = !zn(e),
        _;
      if ((g && (_ = o && o.onVnodeBeforeUnmount) && Q(_, t, e), u & 6))
        _e(e.component, n, r);
      else {
        if (u & 128) {
        ...
        (h && bn(e, null, t, `beforeUnmount`),
          u & 64
            ...
            : l && !l.hasOnce && (a !== K || (d > 0 && d & 64))
              ? ve(l, t, n, !1, !0)
              : ((a === K && d & 384) || (!i && u & 16)) && ve(c, t, n),
          r && he(e));
      }
      let v = m != null && p == null;
    ...
    A = (e, t, n) => {
      let r;
      (e == null
        ? t._vnode && (k(t._vnode, null, null, !0), (r = t._vnode.component))
  ...
  return (
    i && ([Se, j] = i(xe)),
    { render: A, hydrate: Se, createApp: Er(A, Se) }
  );
}
    ...
    for (let e = 0; e < r.length; e++) {
      ...
      (a.shapeFlag & 1 &&
        ...
        ((a.patchFlag <= 0 || a.patchFlag === 32) &&
          ((a = i[e] = Fi(i[e])), (a.el = t.el)),
        !n && a.patchFlag !== -2 && li(t, a)),
        a.type === gi &&
          (a.patchFlag === -1 && (a = i[e] = Fi(a)), (a.el = t.el)),
        a.type === _i && !a.el && (a.el = t.el));
    }
}
function ui(e) {
  let t = e.slice(),
...
function Ci(e) {
  return (
    (e.dynamicChildren = xi > 0 ? q || n : null),
    bi(),
    xi > 0 && q && q.push(e),
    e
  );
...
var Di = ({ key: e }) => e ?? null,
  Oi = ({ ref: e, ref_key: t, ref_for: n }) => (
    typeof e == `number` && (e = `` + e),
    e == null ? null : g(e) || z(e) || h(e) ? { i: U, r: e, k: t, f: !!n } : e
  );
function X(
  e,
  t = null,
...
function Ai(e, t = null, n = null, r = 0, i = null, a = !1) {
  if (((!e || e === rr) && (e = _i), Ti(e))) {
    ...
    return (
      ...
      xi > 0 &&
        !a &&
        q &&
        (r.shapeFlag & 6 ? (q[q.indexOf(e)] = r) : q.push(r)),
      (r.patchFlag = -2),
      r
    );
  }
  if ((ra(e) && (e = e.__vccOpts), t)) {
    ...
    (e && !g(e) && (t.class = k(e)),
      v(n) && (It(n) && !d(n) && (n = s({}, n)), (t.style = ue(n))));
  }
  let o = g(e) ? 1 : mi(e) ? 128 : An(e) ? 64 : v(e) ? 4 : h(e) ? 2 : 0;
  return X(e, t, n, r, i, o, a, !0);
}
function ji(e) {
  return e ? (It(e) || Hr(e) ? s({}, e) : e) : null;
}
...
function Pi(e = ``, t = !1) {
  return t ? (J(), wi(_i, null, e)) : ki(_i, null, e);
}
function Z(e) {
  ...
  if (t == null) t = null;
    ...
    if (r & 65) {
      ...
      !r && !Hr(t)
        ...
        : r === 3 &&
          U &&
          (U.slots._ === 1 ? (t._ = 1) : ((t._ = 2), (e.patchFlag |= 1024)));
    }
  else
    h(t)
      ? ((t = { default: t, _ctx: U }), (n = 32))
      : ((t = String(t)), r & 64 ? ((n = 16), (t = [Ni(t)])) : (n = 8));
  ...
  Ui;
{
  ...
  ((Hi = t(`__VUE_INSTANCE_SETTERS__`, (e) => ($ = e))),
    (Ui = t(`__VUE_SSR_SETTERS__`, (e) => (qi = e))));
}
var Wi = (e) => {
    let t = $;
    return (
  ...
  if (!e.render) {
    if (!t && Zi && !i.render) {
      ...
      if (t) {
        ...
        i.render = Zi(t, s(s({ isCustomElement: n, delimiters: a }, r), o));
      }
    }
...
function na(e) {
  return e.exposed
    ? (e.exposeProxy ||= new Proxy(Wt(Lt(e.exposed)), {
        get(t, n) {
...
var ia = (e, t) => Kt(e, t, qi),
  aa = `3.5.35`,
  oa = void 0,
  sa = typeof window < `u` && window.trustedTypes;
if (sa)
  try {
    oa = sa.createPolicy(`vue`, { createHTML: (e) => e });
  } catch {}
var ca = oa ? (e) => oa.createHTML(e) : (e) => e,
  la = `http://www.w3.org/2000/svg`,
  ua = `http://www.w3.org/1998/Math/MathML`,
  da = typeof document < `u` ? document : null,
  fa = da && da.createElement(`template`),
  pa = {
    insert: (e, t, n) => {
    ...
    createElement: (e, t, n, r) => {
      let i =
        t === `svg`
          ? da.createElementNS(la, e)
          : t === `mathml`
            ? da.createElementNS(ua, e)
            : n
              ? da.createElement(e, { is: n })
              : da.createElement(e);
      return (
        e === `select` &&
          r &&
...
function ba(e, t, n) {
  ...
  if (n && !i) {
    ...
    for (let i in n) {
      ...
      o == null
        ? Sa(r, i, ``)
        : Ea(e, i, !g(t) && t ? t[i] : void 0, o) || Sa(r, i, o);
    }
  } else if (i) {
    if (t !== n) {
      let e = r[va];
...
function Sa(e, t, n) {
  if (d(n)) n.forEach((n) => Sa(e, t, n));
    ...
    let r = Ta(e, t);
    xa.test(n)
      ? e.setProperty(E(r), n.replace(xa, ``), `important`)
      : (e[r] = n);
  }
}
...
function Na(e, t, n, r, i = null) {
  ...
  if (r && o) o.value = r;
    ...
    let [n, s] = Fa(t);
    r ? Aa(e, n, (a[t] = za(r, i)), s) : o && (ja(e, n, o, s), (a[t] = void 0));
  }
}
          ...
          : (
            ...
            ? (ka(e, t, r),
              !e.tagName.includes(`-`) &&
                ...
                Oa(e, t, r, c, s, t !== `value`))
            : e._isVueCE &&
                (Ua(e, t) ||
                  (e._def.__asyncLoader && (/[A-Z]/.test(t) || !g(r))))
              ? ka(e, T(t), r, s, t)
              : (t === `true-value`
                  ? (e._trueValue = r)
...
function Ua(e, t) {
  ...
  return Array.isArray(n)
    ? n.some((e) => T(e) === r)
    : Object.keys(n).some((e) => T(e) === r);
}
var Wa = s({ patchProp: Va }, pa),
  Ga;
function Ka() {
  return (Ga ||= ii(Wa));
}
...
var Xa = {
    class: `text-[rgba(var(--color-foreground,18,18,18),0.88)]`,
    "aria-live": `polite`,
  },
  Za = { class: `mb-5 mt-0 text-[2rem] font-semibold leading-snug` },
  Qa = {
    key: 0,
  ...
  $a = { class: `m-0 grid gap-2` },
  eo = { class: `grid grid-cols-[7rem_minmax(0,1fr)] gap-3` },
  to = { class: `m-0 [overflow-wrap:anywhere] text-[1.3rem] leading-snug` },
  no = { class: `grid grid-cols-[7rem_minmax(0,1fr)] gap-3` },
  ro = { class: `m-0 [overflow-wrap:anywhere] text-[1.3rem] leading-snug` },
  io = { class: `grid grid-cols-[7rem_minmax(0,1fr)] gap-3` },
  ao = { class: `m-0 [overflow-wrap:anywhere] text-[1.3rem] leading-snug` },
  oo = { class: `grid grid-cols-[7rem_minmax(0,1fr)] gap-3` },
  so = { class: `m-0 [overflow-wrap:anywhere] text-[1.3rem] leading-snug` },
  co = { key: 0 },
  lo = { key: 1 },
  uo = { key: 1, class: `m-0 text-[1.4rem] leading-normal` },
  fo = { key: 2, class: `m-0 text-[1.4rem] leading-normal text-[#cf1322]` },
  po = { key: 3 },
  mo = { class: `mb-6 mt-0 grid list-none gap-4 p-0` },
  ho = { class: `mb-1 mt-0 text-[1.6rem] font-semibold leading-snug` },
  go = {
    class: `m-0 text-[1.4rem] leading-normal text-[rgba(var(--color-foreground,18,18,18),0.72)]`,
  },
  _o = { class: `m-0 text-[1.4rem] leading-normal` },
  vo = { key: 4, class: `m-0 text-[1.4rem] leading-normal` },
  yo = {
    key: 5,
  ...
  bo = {
    id: `VueNestPocSizeChartHeading`,
    class: `m-0 text-[1.8rem] leading-snug`,
  },
  xo = {
    class: `overflow-x-auto rounded-[0.5rem] border border-[rgba(var(--color-foreground,18,18,18),0.12)]`,
  },
  So = { class: `w-full min-w-[58rem] border-collapse` },
  Co = {
    scope: `row`,
  ...
  Oo = {
    key: 0,
    class: `m-0 text-[1.3rem] leading-normal text-[rgba(var(--color-foreground,18,18,18),0.72)]`,
  },
  ko = Nn({
    __name: `App`,
    props: { apiUrl: {}, heading: {}, sourceData: {} },
    setup(e) {
      let t = e,
        n = zt(null),
        r = zt(!0),
        i = zt(``),
        a = ia(() => t.sourceData?.sizeChart || null),
        o = ia(() => {
          let e = a.value?.rowsRaw?.trim();
          return e
            ? e
                .split(/\r?\n/)
                .map((e) => e.trim())
      ...
      async function s() {
        ...
        try {
          ...
          i.value = e instanceof Error ? e.message : `未知错误`;
        } finally {
          r.value = !1;
        }
      }
        ...
        (t, s) => (
          ...
          Y(`section`, Xa, [
            (s[5] ||= X(
              `p`,
              {
                class: `mb-1 mt-0 text-[1.2rem] uppercase leading-snug text-[rgba(var(--color-foreground,18,18,18),0.65)]`,
              },
              ` Vue 3 + NestJS POC `,
              -1,
            )),
            X(`h2`, Za, A(e.heading), 1),
            e.sourceData
              ? (J(),
                Y(`div`, Qa, [
                  (s[4] ||= X(
                    `p`,
                    { class: `m-0 text-[1.3rem] font-semibold leading-snug` },
                    `当前页面源对象`,
                    -1,
                  )),
                  X(`dl`, $a, [
                    X(`div`, eo, [
                      (s[0] ||= X(
                        `dt`,
                        {
                          class: `m-0 text-[1.3rem] leading-snug text-[rgba(var(--color-foreground,18,18,18),0.62)]`,
                        },
                        ` 标题 `,
                        -1,
                      )),
                      X(`dd`, to, A(e.sourceData.page.title), 1),
                    ]),
                    X(`div`, no, [
                      (s[1] ||= X(
                        `dt`,
                      ...
                      X(`dd`, ro, A(e.sourceData.page.handle), 1),
                    ]),
                    X(`div`, io, [
                      (s[2] ||= X(
                        `dt`,
                      ...
                      X(`dd`, ao, A(e.sourceData.page.url), 1),
                    ]),
                    X(`div`, oo, [
                      (s[3] ||= X(
                        `dt`,
                      ...
                      X(`dd`, so, [
                        Ni(
                          A(e.sourceData.sizeChart.metaobject.namespace) +
                            `.` +
                            A(e.sourceData.sizeChart.metaobject.key) +
                            ` `,
                          1,
                        ),
                        e.sourceData.sizeChart.metaobject.loaded
                          ? (J(), Y(`span`, co, `已读取`))
                          : (J(),
                            Y(
                              `span`,
                              lo,
                              `未读取到，使用 section blocks 兜底`,
                            )),
                      ]),
                    ]),
                  ]),
              ...
              : Pi(``, !0),
            r.value
              ? (J(), Y(`p`, uo, `正在请求 Nest 接口...`))
              : i.value
                ? (J(), Y(`p`, fo, ` 接口请求失败：` + A(i.value), 1))
                : n.value && n.value.items.length > 0
                  ? (J(),
                    Y(`div`, po, [
                      X(`ul`, mo, [
                        (J(!0),
                      ...
                      X(
                        ...
                        ` 数据来源：` +
                          A(n.value.source) +
                          ` · ` +
                          A(new Date(n.value.generatedAt).toLocaleString()),
                        1,
                      ),
                    ]))
                  : (J(), Y(`p`, vo, `Nest 接口返回了空列表。`)),
            o.value.length
              ? (J(),
                Y(`section`, yo, [
                  X(`h3`, bo, A(a.value?.heading), 1),
                  X(`div`, xo, [
                    X(`table`, So, [
                      X(`thead`, null, [
                        X(`tr`, null, [
                        ...
                        Y(
                          ...
                          ir(
                            ...
                            (e) => (
                              ...
                              Y(`tr`, { key: e.size }, [
                                X(`th`, Co, A(e.size), 1),
                                X(`td`, wo, A(e.shoulder), 1),
                                X(`td`, To, A(e.chest), 1),
                                X(`td`, Eo, A(e.length), 1),
                                X(`td`, Do, A(e.sleeve), 1),
                              ])
                            ),
                          ),
                          128,
  ...
  Ao = `http://localhost:4000/api/vue-nest-poc`,
  jo = `Vue 已挂载到 Liquid 区块`;
function Mo(e) {
  let t = e.parentElement?.querySelector(`[data-vue-nest-poc-source]`);
  if (!t?.textContent) return null;
  try {
    return JSON.parse(t.textContent);
  } catch (e) {
    return (console.warn(`Failed to parse Vue Nest POC source data`, e), null);
  }
}
function No(e) {
  e.dataset.vueNestPocMounted !== `true` &&
    (qa(ko, {
      apiUrl: e.dataset.apiUrl || Ao,
      heading: e.dataset.heading || jo,
      sourceData: Mo(e),
    }).mount(e),
    (e.dataset.vueNestPocMounted = `true`));
}
function Po() {
  let e = document.querySelectorAll(`[data-vue-nest-poc]`);
  if (e.length === 0) {
...
(document.readyState === `loading`
  ...
  : Po(),
  document.addEventListener(`shopify:section:load`, Po));
